...
public class Socket_ServerThread implements Runnable {
	...
	public Socket_ServerThread(Socket socket, TextArea state, DataInputStream dis, DataOutputStream dos, String talkName)
			throws IOException {
	...
	public void broadCasting(String talkName, String message) {
		...
		synchronized (list) {
			...
			while (e.hasMoreElements()) {
				Socket_ServerThread temp = (Socket_ServerThread) e.nextElement();

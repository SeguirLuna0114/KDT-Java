...
public class ServerSocket_BroadCastingServer {
	...
	private Socket_ServerThread st;

	// 생성자임. GUI 폼 구성
	public ServerSocket_BroadCastingServer() {
	...
	public void startServer() {
		...
		try {
			...
			while (true) {
				...
				st = new Socket_ServerThread(socket, state, dis, dos, name);
	...
	public static void main(String[] args) {
		ServerSocket_BroadCastingServer ser = new ServerSocket_BroadCastingServer();
		ser.startServer();
	}
}

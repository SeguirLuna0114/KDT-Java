...
public class Socket_BroadCastingClient implements Runnable, ActionListener {
	...
	// 생성자. 클라이언트 GUI 폼을 구성
	public Socket_BroadCastingClient() {
...
//		second = new Frame( "접속 성공" );
	...
	public static void main(String[] args) {
		Socket_BroadCastingClient bcc = new Socket_BroadCastingClient();
	}
}
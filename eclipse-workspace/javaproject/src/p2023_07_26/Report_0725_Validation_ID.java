...
public class Report_0725_Validation_ID {
	...
	// 향상된 코드
	// 주민번호 유효성 검사 메소드
	static void ValidIDCheck(String IDString) {
		// 주민번호 앞, 뒷자리로 나눠서 확인
	...
	// 주민번호 앞자리가 6자리가 아니면 & 뒷자리가 7자리가 아니면 메시지 출력
	...
	public static void main(String[] args) {
		...
		// 향상된 코드 메소드 - boolean ValidIDCheck()메소드 사용
		ValidIDCheck(IDString);
		
		// ValidIDCheck메소드가 boolean타입일 경우의 예시
//		if(ValidIDCheck(IDString)) {	// true이면

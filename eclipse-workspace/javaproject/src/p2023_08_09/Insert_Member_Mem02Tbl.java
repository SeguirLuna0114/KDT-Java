...
public class Insert_Member_Mem02Tbl extends JFrame implements ActionListener {
	Connection con;
...
//					this.dispose();					
					MemberManagement_Mem02Tbl management = new MemberManagement_Mem02Tbl();
	...
	public static void main(String[] args) {
		Insert_Member_Mem02Tbl insert = new Insert_Member_Mem02Tbl();
	}
}